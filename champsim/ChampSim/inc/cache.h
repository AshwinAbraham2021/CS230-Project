...
#define LLC_LATENCY (((0.001*LLC_SET*LLC_WAY - 2)*10.0/3.0) + 20) // 4/5 (L1I or L1D) + 10 + 20 = 34/35 cycles
...
class CACHE : public MEMORY {
  public:
    ...
    void back_invalidate(uint64_t cache_level, uint64_t set, uint64_t way );   //////////changed
