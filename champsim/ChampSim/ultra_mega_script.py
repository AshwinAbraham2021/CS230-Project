...
def run_stuff(REPL_POLICY, L2_SIZE, LLC_SIZE, CACHE_TYPE):
    # with SEMAPHORE:
    print(f'Running {REPL_POLICY} {L2_SIZE} {LLC_SIZE} {CACHE_TYPE}')
...
if __name__ == '__main__':
    ...
    part1 = CARTES_PROD[:72]
    part2 = CARTES_PROD[72:]
    # part3 = CARTES_PROD[100:]
    print("Part I")
    with Pool(len(part1)) as p:
        p.starmap(run_stuff, part1)
    print("Part II")
    with Pool(len(part1)) as p:
        p.starmap(run_stuff, part2)
    # print("Part III")
    # with Pool(len(part1)) as p:
    #     p.starmap(run_stuff, part3)
